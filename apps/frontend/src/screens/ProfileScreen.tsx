  ...
  return (
    <div className="p-8 max-w-4xl mx-auto animate-in fade-in duration-500">
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white">Profile</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1 font-bold text-lg">Manage your account settings and preferences.</p>
        </div>
      </div>
      ...
      <div className="grid gap-8">
        <div className="saas-card dark:bg-slate-900">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 pl-1">Email Address</label>
            ...
            <div>
              <label className="block text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 pl-1">Account ID</label>
              <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700">
        ...
        <div className="saas-card bg-slate-50/50 dark:bg-slate-800/30 border-dashed border-2">
          <div className="text-center py-10">
            <h3 className="text-slate-900 dark:text-white font-bold text-lg mb-2">More settings coming soon</h3>
