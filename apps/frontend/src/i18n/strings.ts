export const strings = {
  en: {
    ...
    reviewActionDesc: 'No total was read. Enter the amount printed on the receipt.',
    ...
    fixFlaggedDesc: 'Add a short reason to mark this expense as valid, or save a note.',
  ...
  fr: {
    ...
    reviewActionDesc: "Aucun total n’a été lu. Saisissez le montant imprimé sur le reçu.",
    ...
    fixFlaggedDesc: "Ajoutez une courte raison pour valider cette dépense, ou enregistrez une note.",
    ...
    detailNeedsYou: "À votre attention",
  ...
  ar: {
    ...
    reviewActionDesc: 'لم يُقرأ المجموع. أدخل المبلغ المطبوع على الإيصال.',
    ...
    fixFlaggedDesc: 'أضف سببًا قصيرًا لاعتماد هذا المصروف، أو احفظ ملاحظة.',
