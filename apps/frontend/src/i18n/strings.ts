export const strings = {
  en: {
    ...
    ledgerReceiptsOne: "{n} receipt",
    ledgerReceiptsOther: "{n} receipts",
    ...
    ledgerNeedsReviewOne: "{n} receipt needs your review",
    ledgerNeedsReviewOther: "{n} receipts need your review",
    ledgerByCategory: "By category",
    ledgerNotYetSorted: "{n} not yet sorted",
    ...
    ledgerExcludedDuplicateOne: "{n} possible duplicate",
    ledgerExcludedDuplicateOther: "{n} possible duplicates",
    ledgerExcludedNoAmount: "{n} without an amount",
    ledgerExcludedStatus: "{n} rejected or not read",
  ...
  fr: {
    ...
    ledgerReceiptsOne: "{n} reçu",
    ledgerReceiptsOther: "{n} reçus",
    ...
    ledgerNeedsReviewOne: "{n} reçu attend votre vérification",
    ledgerNeedsReviewOther: "{n} reçus attendent votre vérification",
    ledgerByCategory: "Par catégorie",
    ledgerNotYetSorted: "Pas encore classés : {n}",
    ...
    ledgerExcludedDuplicateOne: "{n} doublon possible",
    ledgerExcludedDuplicateOther: "{n} doublons possibles",
    ledgerExcludedNoAmount: "{n} sans montant",
    ledgerExcludedStatus: "{n} rejetés ou non lus",
  ...
  ar: {
    ...
    ledgerReceiptsOne: "الإيصالات: {n}",
    ledgerReceiptsOther: "الإيصالات: {n}",
    ledgerNoCurrency: "العملة غير مقروءة",
    ledgerSeparateCurrencies: "تُجمع كل عملة على حدة، دون تحويل ودون جمع بين العملات.",
    ledgerNeedsReviewOne: "إيصالات تنتظر مراجعتك: {n}",
    ledgerNeedsReviewOther: "إيصالات تنتظر مراجعتك: {n}",
    ledgerByCategory: "حسب الفئة",
    ledgerNotYetSorted: "لم تُصنَّف بعد: {n}",
    ...
    ledgerExcludedDuplicateOne: "مكررات محتملة: {n}",
    ledgerExcludedDuplicateOther: "مكررات محتملة: {n}",
    ledgerExcludedNoAmount: "بلا مبلغ: {n}",
    ledgerExcludedStatus: "مرفوضة أو غير مقروءة: {n}",
