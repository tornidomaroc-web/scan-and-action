...
// "يحتوي هذا المستند على معلومات بالفعل، فلا حاجة إلى إعادة معالجته."
const AR_HAS_CONTENT =
  ...
  'حاجة' + // حاجة    (need)
  ' ' +
  'إلى' + // إلى     (for)  -> "لا حاجة إلى" = no need for
  ' ' +
  'إعادة' + // إعادة   (re-)
  ' ' +
  'معالجته' + // معالجته (processing it)
  '.';

// "يحتوي هذا المستند على تعديلاتك الخاصة. كانت إعادة المعالجة ستستبدلها، لذلك لم تبدأ."
const AR_HAS_USER_EDITS =
  ...
  '.' +
  ' ' +
  'كانت' + // كانت      (was)  -> كان + س = the COUNTERFACTUAL: "would have"
  ' ' +
  'إعادة' + // إعادة     (re-)
  ' ' +
